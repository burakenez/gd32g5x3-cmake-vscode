[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32g5x3-cmake-vscode)](https://github.com/burakenez/gd32g5x3-cmake-vscode/tags/)

# GD32G5x3 Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32G5x3 Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32G5x3 Demo Suites V1.4.0](https://www.gd32mcu.com/en/download)_** and **_[GD32G5x3 Firmware Library V1.5.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32g5x3-cmake-vscode.git
```
...
### 2. **CMSIS/GD/GD32G5x3**
- **Version:** `V1.5.0 (2026-02-04)`
- **Path:** `Drivers/CMSIS/GD/GD32G5x3`
- **Source:** `GD32G5x3 Demo Suites V1.4.0`

### 3. **GD32G5x3_standard_peripheral**
- **Version:** `V1.5.0 (2026-02-04)`
- **Path:** `Drivers/GD32G5x3_standard_peripheral`
- **Source:** `GD32G5x3 Demo Suites V1.4.0`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32g5x3_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32g5x3_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32g5x3_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32g5x3.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32g5x3.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32G553C_START              # Board support package for GD32G553C_START
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32G5x3
│           │   └── GD32G5x3_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32g5x3_flash.ld  # Linker script (memory regions)
│           └── GD32G5x3.svd             # SVD file for peripheral register views
